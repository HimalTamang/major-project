            ...
            <div class="divA">
                ...
                <div class="divB">
                    <div class="divD">
                        <p>Click On Menu</p>
                        <?php
                                    require 'connection.php'; // Selecting Database
                                    //MySQL Query to read data
                                    $query = mysql_query("select * from business", $conn);
                    ...
                    <?php
                                if (isset($_GET['id'])) {
                                $id = $_GET['id'];
                                $query1 = mysql_query("select * from business where businesstype='guest-house'", $connection);
